...
// Based on API enum: https://github.com/bcgov/lear/blob/main/legal-api/src/legal_api/services/warnings/business/business_checks/__init__.py#L18
// Fill in others as needed
export enum ApiWarningType {
