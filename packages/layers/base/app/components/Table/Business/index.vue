...
const tableUi = computed(() => {
  ...
  const tr = [
    ...
    "relative after:absolute after:content-[''] after:bottom-0 after:h-px after:bg-gray-200 [thead_&]:first:after:hidden last:after:hidden data-[expanded=true]:after:hidden",
