...
export default {
  ...
  modal: {
    ...
    unsupportedCurrencyType: {
      title: 'Update Your Currency Type',
      description: "To add a new series, you'll need to update this share class to a supported currency."
    }
  },
  label: {
    actions: 'Actions',
    ...
    addNameTranslation: 'Add Name Translation',
    alerts: 'Alerts',
    ...
    business: 'Business',
    businessFullNameInHomeJurisdiction: 'Business’ full legal name in home jurisdiction',
    ...
    courtOrderDocumentUpload: 'Court Order Document Upload',
    ...
    corpNum: 'Corporate Number',
    corpNumHomeJurisdiction: 'Corporate number in home jurisdiction',
    correcting: 'Correcting',
    correctingItemName: 'Correcting {name}',
    currency: 'Currency',
    currentDirectors: 'Current Directors',
    currentLiquidators: 'Current Liquidators',
    ...
    mailingAddressOrJurisdiction: 'Mailing Address or Jurisdiction',
    ...
    no: 'No',
    none: 'None',
    noShareClasses: 'No Share Classes',
    ...
    resolutionsOrCourtOrdersRegardingShares: 'Resolutions or Court Orders Regarding Shares',
    ...
    selectHomeJurisdiction: 'Select Home Jurisdiction',
    seriesNameShares: 'Series Name [Shares]',
    shareClass: 'Share Class',
    shareClasses: 'Share Classes',
    shareClassHasRightsOrRestrictions: 'This share class has special rights or restrictions',
    ...
    uploadCourtOrder: 'Upload Court Order',
  ...
  text: {
    ...
    certifyDescription: 'Certify your authorization to complete and submit this filing. The name of the person submitting this filing will be displayed in the history of filings for this {entityType}.',
    certifyIsAuthorized: 'I certify that the information provided is correct and that I am authorized to submit this filing on behalf of the {entitytype}.',
    completeYourFilingToDisplay: 'Complete your filing to display',
    confirmAuthorizationDescription: 'Confirm your authorization to complete and submit this filing. The name of the person submitting this filing will be displayed in the history of filings for this {entityType}.',
    confirmAuthorizationIsAuthorized: 'I confirm that the information provided is correct and that I am authorized to submit this filing on behalf of the {entitytype}.',
    ...
    correctTyposCompanyName: 'Correct typographical errors in the existing company name.',
    ...
    documentNoLongerExistsOnServer: 'This document no longer exists on the server.',
    effectiveAsOf: 'EFFECTIVE as of',
    enterDateResolutionChangedShares: 'Enter the date of the resolution or court order that altered the company’s share structure.',
    ...
    orDragAndDropFiles: 'or drag and drop files',
    ...
    parValueHelp: 'Initial value of each share',
  ...
  validation: {
    amountMustBeGreaterThan: 'Amount must be greater than {count}',
    ...
    fileMustBeUnencryptedNamed: '{filename} must be unencrypted.',
    fileTooLargeNamed: '{filename} is too large. Files must be {maxsize} or smaller.',
    ...
    invalidFileTypeNamed: '{filename} isn’t a supported file type. Upload a {validtype}.',
    invalidPageSizeLetterNamed: '{filename} must be set to fit onto 8.5” x 11” letter-size paper.',
